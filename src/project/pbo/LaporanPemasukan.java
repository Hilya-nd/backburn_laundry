...
public class LaporanPemasukan extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(LaporanPemasukan.class.getName());
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Minggu Ke", "Periode", "Total Order", "Total Berat(KG)", "Total Pendapatan"
            }
        ));
        ...
        jButton3.setText("Reservasi Offline");
        ...
        jButton2.setText("Reservasi Online");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new LaporanPemasukan().setVisible(true));
    }
